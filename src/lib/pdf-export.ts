...
const PAGE_MARGIN_MM = 10; // ขอบกระดาษ A4 ให้เนื้อหาไม่ชนขอบเวลาพิมพ์จริง
...
// การย่อให้พอดีความสูงจะย่อความกว้างตามไปด้วย ทำให้เกิดขอบขาวซ้าย-ขวาเพิ่มขึ้น
// จึงยอมย่อได้แค่เล็กน้อย (1.04 ≈ ขอบกว้างขึ้นข้างละ ~4 มม.) ถ้าเกินนี้ให้ตัดหน้าแทน
const FIT_SINGLE_PAGE_RATIO = 1.04;
