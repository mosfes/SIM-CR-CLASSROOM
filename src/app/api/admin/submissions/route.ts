  ...
  return {
    ...
    nurse: card.nurseInterview
      ? {
          ...
          endocrineGlandChoice: card.nurseInterview.endocrineGlandChoice,
          abnormalHormoneChoice: card.nurseInterview.abnormalHormoneChoice,
          isGlandCorrect: card.nurseInterview.isGlandCorrect,
          isHormoneCorrect: card.nurseInterview.isHormoneCorrect,
          evaluationScore: card.nurseInterview.evaluationScore,
    ...
    pharmacy: card.pharmacyDispense
      ? {
          ...
          hormoneChoiceKey: card.pharmacyDispense.hormoneChoiceKey,
          hormoneChoiceLabel: card.pharmacyDispense.hormoneChoiceLabel,
          treatmentChoiceKey: card.pharmacyDispense.treatmentChoiceKey,
          treatmentChoiceLabel: card.pharmacyDispense.treatmentChoiceLabel,
          isHormoneCorrect: card.pharmacyDispense.isHormoneCorrect,
          isTreatmentCorrect: card.pharmacyDispense.isTreatmentCorrect,
          isCorrect: card.pharmacyDispense.isCorrect,
          evaluationScore: card.pharmacyDispense.evaluationScore,
